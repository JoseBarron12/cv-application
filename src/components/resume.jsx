    ...
    <div>
      <div className="resume">
        <div className="general-resume">
          {generalInput != null && (
            <div className="header-general">{generalInput.name}</div>
          )}
          {generalInput != null && (
            <div className="info-general">
              {generalInput.email != "" &&
                generalInput.email != undefined &&
                generalInput.email + " | "}
              {generalInput.number != "" &&
                generalInput.number != undefined &&
                generalInput.number + " | "}
              {generalInput.linkedIn != "" &&
                generalInput.linkedIn != undefined &&
                generalInput.linkedIn + " | "}
              {generalInput.github != "" &&
                generalInput.github != undefined &&
                generalInput.github}
            </div>
          )}
        </div>
                      ...
                      <>
                        ...
                        {skill.skills != undefined &&
                          ...
                          skill.skills.map((sk, index) => {
                            ...
                            return <>{preText + sk.skill + postText}</>;
                          })}
                      </>
                    </p>
                  );
                    ...
                    <div key={edu.id} className="general-edu-container">
                      ...
                      <div className="edu-info">
                        ...
                        {edu.startDate != "" &&
                          ...
                          edu.startDate.month != undefined &&
                          edu.startDate.year != undefined &&
                          format(edu.startDate.month, "MMM") +
                            " " +
                            format(edu.startDate.year, "yyy") +
                            " — "}
                        {edu.endDate != "" &&
                          edu.endDate != undefined &&
                          edu.endDate.month != undefined &&
                          edu.endDate.year != undefined &&
                          format(edu.endDate.month, "MMM") +
                            " " +
                            format(edu.endDate.year, "yyy")}
                      </div>
                      <ul className="edu-bullet-pts">
                        {edu.grade != undefined && edu.grade != "" && (
                          <Grade grade={edu.grade} />
                        )}
                        {edu.achievements != undefined &&
                          edu.achievements != "" &&
                          edu.achievements.length != 0 &&
                          edu.achievements.map((ach) => {
                            return <li key={ach.id}>{ach.achievement}</li>;
                          })}
                      </ul>
                    </div>
                  );
                    ...
                    <div key={exp.id} className="general-exp-container">
                      ...
                      <div className="edu-info">
                        ...
                        {exp.startDate != "" &&
                          ...
                          exp.startDate.month != undefined &&
                          exp.startDate.year != undefined &&
                          format(exp.startDate.month, "MMM") +
                            " " +
                            format(exp.startDate.year, "yyy") +
                            " — "}
                        {exp.endDate != "" &&
                          exp.endDate != undefined &&
                          exp.endDate.month != undefined &&
                          exp.endDate.year != undefined &&
                          format(exp.endDate.month, "MMM") +
                            " " +
                            format(exp.endDate.year, "yyy")}
                      </div>
                      <ul className="edu-bullet-pts">
                        {exp.responsibility != undefined &&
                          exp.responsibility != "" && (
                            <Responsibility resp={exp.responsibility} />
                          )}
                        {exp.achievements != undefined &&
                          exp.achievements != "" &&
