...
function EducationSectionForm({
  ...
  const defaultStartDate =
    selectedEdu != null && selectedEdu.startDate != undefined
      ? selectedEdu.startDate
      : "";
  const [startDate, setStartDate] = useState(defaultStartDate);

  const defaultEndDate =
    selectedEdu != null && selectedEdu.endDate != undefined
      ? selectedEdu.endDate
      : "";
  const [endDate, setEndDate] = useState(defaultEndDate);

  const defaultAchievements =
    selectedEdu != null ? selectedEdu.achievements : "";
    ...
    <form className={"education-info"}>
      <fieldset>
        ...
        <div
          ...
          onClick={() => {
            addActive("school-name");
          }}
          onMouseEnter={() => {
            addActive("school-name");
          }}
          onMouseLeave={() => {
            removeActive("school-name");
          }}
        >
          ...
          <GeneralInput
            ...
            endDate={endDate}
            achievements={achievements}
            callBack={setSchoolName}
          />
        </div>
        <div
          className="input-field"
          onClick={() => {
            addActive("location-name");
          }}
          onMouseEnter={() => {
            addActive("location-name");
          }}
          onMouseLeave={() => {
            removeActive("location-name");
          }}
        >
      ...
      <fieldset>
        ...
        <div
          className="input-field"
          onClick={() => {
            addActive("degree-name");
          }}
          onMouseEnter={() => {
            addActive("degree-name");
          }}
          onMouseLeave={() => {
            removeActive("degree-name");
          }}
        >
          ...
          <GeneralInput
            ...
            endDate={endDate}
            achievements={achievements}
            callBack={setDegreeName}
          />
        </div>
        <div
          className="input-field"
          onClick={() => {
            addActive("field-name");
          }}
          onMouseEnter={() => {
            addActive("field-name");
          }}
          onMouseLeave={() => {
            removeActive("field-name");
          }}
        >
          ...
          <GeneralInput
            ...
            endDate={endDate}
            achievements={achievements}
            callBack={setFieldName}
          />
        </div>
        <div className="input-field-date">
          <label htmlFor="start-date">Start date</label>
          <EducationSectionFormDate
            isStart={true}
            idName={"start-date"}
        ...
        <div
          className="input-field"
          onClick={() => {
            addActive("grade-name");
          }}
          onMouseEnter={() => {
            addActive("grade-name");
          }}
          onMouseLeave={() => {
            removeActive("grade-name");
          }}
        >
          ...
          <GeneralInput
            ...
            endDate={endDate}
            achievements={achievements}
            callBack={setGradeValue}
          />
        </div>
      </fieldset>
      <div className="additional-achievement-section">
        <button type="button" onClick={onBtnClick(showAchievements)}>
        ...
        {showAchievements && (
          <EducationSectionFormAchievement
            achievements={achievements}
...
function EducationSectionFormDate({
  isStart,
  idName,
  currentDate,
  setCurrentDate,
  ...
  return (
    <fieldset>
      ...
      <div
        className="input-field"
        onClick={() => {
          addActive("achievement-info");
        }}
        onMouseEnter={() => {
          addActive("achievement-info");
        }}
        onMouseLeave={() => {
          removeActive("achievement-info");
        }}
      >
        <label htmlFor="achievement-info">
          Name
          <button
          ...
          return (
            <div className="achievement-container" key={achievement.id}>
              ...
              <button className="achievement-btn">
                <Icon path={mdiEyeOutline} className="link-icon" />
              </button>
              <button className="achievement-btn">
                <Icon
                  path={mdiDelete}
