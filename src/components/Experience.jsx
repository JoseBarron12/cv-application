...
function ExperienceSectionForm({
  ...
  const defaultResponsibility =
    selectedExp != null ? selectedExp.responsibility : "";
  const [responsibilityName, setResponsibilityName] = useState(
    defaultResponsibility,
  );

  const defaultStartDate =
    selectedExp != null && selectedExp.startDate != undefined
      ? selectedExp.startDate
      : "";
  const [startDate, setStartDate] = useState(defaultStartDate);

  const defaultEndDate =
    selectedExp != null && selectedExp.endDate != undefined
      ? selectedExp.endDate
      : "";
  const [endDate, setEndDate] = useState(defaultEndDate);

  const defaultAchievements =
    selectedExp != null ? selectedExp.achievements : "";
    ...
    <form className="exp-info">
      <fieldset>
        ...
        <div
          ...
          onClick={() => {
            addActive("position-name");
          }}
          onMouseEnter={() => {
            addActive("position-name");
          }}
          onMouseLeave={() => {
            removeActive("position-name");
          }}
        >
        ...
        <div
          className="input-field"
          onClick={() => {
            addActive("company-name");
          }}
          onMouseEnter={() => {
            addActive("company-name");
          }}
          onMouseLeave={() => {
            removeActive("company-name");
          }}
        >
      ...
      <fieldset>
        ...
        <div
          className="input-field"
          onClick={() => {
            addActive("responsibility-name");
          }}
          onMouseEnter={() => {
            addActive("responsibility-name");
          }}
          onMouseLeave={() => {
            removeActive("responsibility-name");
          }}
        >
          ...
          <GeneralInput
            ...
            name={"responsibility"}
            id={"responsibility"}
            callBack={setResponsibilityName}
            currentId={currentId}
            setCurrentId={setCurrentId}
            userExp={userExp}
            setUserExp={setUserExp}
            initialValue={responsibilityName}
            positionName={positionName}
            companyName={companyName}
            locationName={locationName}
            responsibilityName={responsibilityName}
      ...
      <div className="additional-achievement-section">
        ...
        {showAchievements && (
          <ExperienceSectionFormAdditional
            achievements={achievements}
...
function ExperienceSectionFormDate({
  isStart,
  idName,
  currentDate,
  setCurrentDate,
